        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover table-condensed">
                ...
                <tbody>
                    ...
                    <td class="text-left col-sm-6 col-md-6 col-lg-8">점심 이후 디자인 작업</td>
                    <td class="text-center col-sm-2 col-md-2 col-lg-1">이은빈</td>
                    ...
                    <td class="text-left col-sm-6 col-md-6 col-lg-8">점심 이후 디자인 작업</td>
                    <td class="text-center col-sm-2 col-md-2 col-lg-1">문서혜</td>
                    <td class="text-center col-sm-2 col-md-2 col-lg-1">2022-05-24</td>
                    <td class="text-right col-sm-1 col-md-1 col-lg-1">0</td>
                    </tr>
                    <tr>
                    ...
                    <td class="text-left col-sm-6 col-md-6 col-lg-8">점심 이후 디자인 작업</td>
                    <td class="text-center col-sm-2 col-md-2 col-lg-1">김주혜</td>
                    <td class="text-center col-sm-2 col-md-2 col-lg-1">2022-05-24</td>
                    <td class="text-right col-sm-1 col-md-1 col-lg-1">0</td>
                    </tr>                    
                    <tr>
                    <td class="text-center col-sm-1 col-md-1 col-lg-1">4</td>
                    <td class="text-left col-sm-6 col-md-6 col-lg-8">점심 이후 디자인 작업</td>
                    <td class="text-center col-sm-2 col-md-2 col-lg-1">최유빈</td>
                    <td class="text-center col-sm-2 col-md-2 col-lg-1">2022-05-24</td>
                    <td class="text-right col-sm-1 col-md-1 col-lg-1">0</td>
                    </tr>                    
                </tbody>
