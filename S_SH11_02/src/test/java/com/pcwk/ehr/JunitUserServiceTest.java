...
public class JunitUserServiceTest {
	...
	public void setUp() throws Exception {
		 ...
		 */
		list = Arrays.asList(
				new UserVO("p22", "이은빈22", "4321", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER-1, 0, "eunbin620@naver.com","날짜_사용안함"),
				new UserVO("p220", "이은빈220", "4321", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER, 10, "eunbin620@naver.com","날짜_사용안함"),
				new UserVO("p2200", "이은빈2200", "4321", Level.SILVER, MIN_LOGCOUNT_FOR_SILVER+1, MIN_RECOMMEND_FOR_GOLD-1, "eunbin620@naver.com","날짜_사용안함"),
				new UserVO("p22000", "이은빈22000", "4321", Level.SILVER, MIN_LOGCOUNT_FOR_SILVER+1, MIN_RECOMMEND_FOR_GOLD, "eunbin620@naver.com","날짜_사용안함"),
				new UserVO("p220000", "이은빈220000", "4321", Level.GOLD, MIN_LOGCOUNT_FOR_SILVER+2, MIN_RECOMMEND_FOR_GOLD+1, "eunbin620@naver.com","날짜_사용안함")
				);
